...
// key = Object.getOwnPropertyNames(prices)
// values = Object.values(prices)
// val = Object.values(stock)
...
// 5.
    ...
    // let n = sheeps.indexOf(Math.max.apply(null, sheeps))
    // sheeps[n] = 8
    ...
    // sheeps[Math.max.apply(null, sheeps)] = 8
    // console.log(`After shearing, here is my flock: ${sheeps}`)
